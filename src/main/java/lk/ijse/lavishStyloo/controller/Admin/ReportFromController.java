...
//        return series;
    ...
    private void setYear() {
        try {
            List<String> distinctYears = OrderModel.findDistinctYears();
    ...
    private List<ReportCm> getYearlySupplerOrders() {
        List<ReportCm> list = null;
        try {
            list = SupperOrderModel.getYearlySupplierOrder(String.valueOf(cmbYear.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
        return list;
    ...
    private List<ReportCm> getYearlyAppointmentChart() {
        List<ReportCm> list = null;
        try {
            list = BookingModel.getYearlyAppointment(String.valueOf(cmbYear.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
        return list;
    ...
    private List<ReportCm> getYearlyCustomerOrder() {
        List<ReportCm> list = null;
        try {
            list = CustomerModel.getYearlyCustomerOrder(String.valueOf(cmbYear.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
        return list;
    ...
    private List<ReportCm> getMonthlySupplerOrders() {
        List<ReportCm> list = null;
        try {
            list = SupperOrderModel.getMonthlySupplierOrder(DateTimeUtil.yearNow(),String.valueOf(cmbMonth.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
        return list;
    ...
    private List<ReportCm> getMonthlyAppointmentChart() {
        List<ReportCm> list = null;
        try {
            list = BookingModel.getMonthlyAppointment(DateTimeUtil.yearNow(),String.valueOf(cmbMonth.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
    ...
    private List<ReportCm> getMonthlyCustomerOrder() {
        List<ReportCm> list = null;
        try {
            list = CustomerModel.getMonthlyCustomerOrder(DateTimeUtil.yearNow(),String.valueOf(cmbMonth.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
    ...
    private List<ReportCm> getDaySupplerOrders() {
        List<ReportCm> list = null;
        try {
            list = SupperOrderModel.getMonthlySupplierOrder((String) cmbYear.getValue(),String.valueOf(cmbMonth.getValue()));
    ...
    private List<ReportCm> getDayAppointmentChart() {
        List<ReportCm> list = null;
        try {
            list = BookingModel.getMonthlyAppointment(String.valueOf(cmbYear.getValue()),String.valueOf(cmbMonth.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
    ...
    private List<ReportCm> getDayCustomerOrder() {
        List<ReportCm> list = null;
        try {
            list = CustomerModel.getMonthlyCustomerOrder(String.valueOf(cmbYear.getValue()),String.valueOf(cmbMonth.getValue()));
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
        }
        return list;
